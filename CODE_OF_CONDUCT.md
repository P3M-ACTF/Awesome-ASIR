...
Instancias de comportamiento abusivo, acosador o de otro modo inaceptable pueden reportarse a los administradores de la comunidad abriendo una issue en [Awesome-ASIR](https://github.com/P3M-ACTF/Awesome-ASIR/issues/new) con el prefijo `[Conducta]` en el título y **sin incluir detalles sensibles** en el cuerpo público. Un mantenedor te pedirá un canal privado para continuar. Todas las quejas serán evaluadas e investigadas de una manera puntual y justa.
...
Para respuestas a las preguntas frecuentes de este código de conducta, consulta las [FAQ](https://www.contributor-covenant.org/faq). Hay [traducciones](https://www.contributor-covenant.org/translations) disponibles.
